...
<div class="row row-cols-1 row-cols-lg-3 row-cols-xl-3 row-cols-xxl-3">
    @php
        $kpis = [
            ...
            ['title' => __('messages.total_customers'), 'value' => $totalCustomers > 0 ? number_format($totalCustomers) : '0', 'icon' => 'bi bi-people'],
...
<ul class="nav nav-tabs mt-4" id="dashboardTabs" role="tablist">
    ...
    <li class="nav-item" role="presentation">
        <button class="nav-link" id="top-vendors-tab" data-bs-toggle="tab" data-bs-target="#top-vendors" type="button" role="tab">
            {{ __('messages.top_5_vendors') }}
        </button>
    </li>
</ul>
...
<div class="tab-content mt-3" id="dashboardTabsContent">
            ...
            <div class="card-body">
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $order->id }}</td>
                            <td>{{ $order->vendor->name ?? __('messages.na') }}</td>
                        ...
                        @empty
                        <tr>
                            <td colspan="5" class="text-center">{{ __('messages.no_orders_available') }}</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
    ...
    <!-- Top 5 Vendors -->
    <div class="tab-pane fade" id="top-vendors" role="tabpanel">
        <div class="card radius-10">
            <div class="card-body">
                <h6 class="mb-3">{{ __('messages.top_5_vendors') }}</h6>
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            <th>{{ __('messages.vendor') }}</th>
